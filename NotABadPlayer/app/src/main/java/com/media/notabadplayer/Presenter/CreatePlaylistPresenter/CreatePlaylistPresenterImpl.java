...
public class CreatePlaylistPresenterImpl implements CreatePlaylistPresenter {
    ...
    public CreatePlaylistPresenterImpl(@NonNull Context context,
                                       @NonNull AudioInfo audioInfo,
                                       @NonNull CreatePlaylistPresenterDelegate delegate,
                                       @Nullable BaseAudioPlaylist templatePlaylist)
    {
        this._searchPresenter = new SearchPresenterImpl(context, audioInfo, false);
    ...
    public CreatePlaylistPresenterImpl(@NonNull Context context, @NonNull AudioInfo audioInfo, @NonNull CreatePlaylistPresenterDelegate delegate)
    {
    ...
    public void start()
    {
        Log.v(CreatePlaylistPresenterImpl.class.getCanonicalName(), "Start.");
    ...
    {
        return _searchPresenter.getSearchResults();
    }

    @Override
    public void setView(@NonNull SearchView view) {
        _searchPresenter.setView(view);
    }
